...
group :development do
  ...
  gem 'rspec-rails', '~> 2.9.0' # In order to have rspec tasks and generators
  gem 'rspec-cells', '>= 0.1.10'

  gem 'unicorn' , '>= 4.6.0' # Using unicorn_rails instead of webrick (default server)
